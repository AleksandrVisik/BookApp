    ...
    class Card extends DivComponent {
        ...
        render() {
            ...
            <div class="card__info">
                <div class="card__tag">Первая публикация в 
                    ${this.cardState.first_publish_year} году. Количество изданий ${this.cardState.edition_count}
